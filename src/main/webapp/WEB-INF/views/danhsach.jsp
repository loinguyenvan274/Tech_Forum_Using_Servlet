...
<head>
    ...
    <title>Diễn Đàn Công Nghệ - Trang Chủ</title>
    ...
    <div class="container">
        ...
        <header class="header">
            ...
            <div class="search-container">
                <form action="${pageContext.request.contextPath}/timkiem" method="get" class="search-form">
                    <input type="text" name="q" placeholder="Tìm kiếm câu hỏi..." class="search-input">
        ...
        <main class="main-content">
            <div class="section-header">
                ...
                <p class="text-muted">Tổng số: ${danhSachCauHoi.size()} câu hỏi</p>
            </div>
            ...
            <div class="question-list">
                ...
                <c:if test="${empty danhSachCauHoi}">
                    <div class="empty-state">
                        ...
                        <a href="${pageContext.request.contextPath}/dangcauhoi" class="btn btn-primary">Đặt Câu Hỏi Đầu Tiên</a>
                    </div>
                </c:if>
            </div>
        </main>
